...
class ColorTheme: Object {
  ...
  @objc dynamic var textColor: String = ColorName.black.toHexString()

  convenience init(title: String, color: String, textColor: String = ColorName.black.toHexString()) {
    self.init()
    self.title = title
    self.color = color
...
struct ColorThemeTemplate: OptionSet {
  ...
  static let all = [white, red, purple, indigo, pink, blue, cyan, teal, green, lime, yellow, brown, gray]
}
